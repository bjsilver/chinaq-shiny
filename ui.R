    ...
    tabPanel("Trends",
      ...
      div(class="outer",
        ...
        absolutePanel(top = 60, right = 10, draggable=FALSE,id="controls",style="z-index:500;", fixed=TRUE,
                      ...
                      # ,
                      # div(tags$style(type = "text/css", ".outer {position: fixed; top: 0px; left: 0; right: 0; bottom: ; overflow: hidden; padding: 100}"),
                      #     selectInput('province', 'Province', unique(trends$province), selectize=TRUE))
        ),
